...
const mockSeedHex = '1234567890123456789012345678901234567890123456789012345678901234'
const mockPublicKeyHex = 'c9df7bcba2238bedcc681e8b17bb21c1625d21d285b70c20cf53fdd473db9dfb'
const mockSecretKeyKeyHex = '1234567890123456789012345678901234567890123456789012345678901234c9df7bcba2238bedcc681e8b17bb21c1625d21d285b70c20cf53fdd473db9dfb'
...
describe('Array', () => {
  describe('Tests', () => {
    ...
    it('should convert a KeyPair', async () => {
      const keyPairJwk = await convertToJwk(mockPublicKeyHex, mockSecretKeyKeyHex)
